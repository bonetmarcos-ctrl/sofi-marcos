...
const translations: Record<Language, Record<string, string>> = {
  ...
  ca: {
    ...
    "Edit event": "Editar esdeveniment", "New event": "Nou esdeveniment", Type: "Tipus", "Who is it for?": "De qui és?", "Booking details": "Dades de la reserva", Guests: "Hostes", "Example guests": "Ex: Marc & Sofia", Nights: "Nits", "per night": "€/nit", single: "individual", couple: "parella", "family/free": "família/gratis", Total: "Total", "Car rental": "Lloguer de cotxe", Days: "Dies", Net: "Net", Description: "Descripció", "What is it?": "Què és?", Date: "Data", Time: "Hora", "Amount (€)": "Import (€)", Notes: "Notes", "Details...": "Detalls...", "Extra income": "Ingrés extra", "Variable expense": "Despesa variable", "Save changes": "Guardar canvis", "Save event": "Guardar esdeveniment", Delete: "Eliminar", "Delete this event?": "Eliminar aquest esdeveniment?", "Want to add a trip? Use the Add trip button in the main menu.": "Vols afegir un viatge? Usa el botó Viatge del menú principal.",
