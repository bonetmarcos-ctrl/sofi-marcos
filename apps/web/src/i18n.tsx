...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "Iter pillar projects": "Projects",
    "Iter pillar projects copy": "Turn big intentions into concrete paths.",
    "Iter pillar time": "Time",
    "Iter pillar time copy": "See the real capacity of your home and family.",
    "Iter pillar resources": "Resources",
    "Iter pillar resources copy": "Understand money, margin and what makes plans viable.",
    "Access your Iter space": "Access your Iter space",
    "Start a shared space": "Start a shared space",
    "Iter auth note": "Your plans stay connected: what matters, when it can happen, and what resources make it possible.",
    Language: "Language",
    Budget: "Budget",
    Calendar: "Calendar",
    Home: "Home",
    ...
    "Went up {amount}": "Went up {amount}",
    "Went down {amount}": "Went down {amount}",
    ...
    "Annual expense evolution": "Annual expense evolution",
    "Annual expense evolution help": "Bars show monthly expenses by layer. The solid line is stable fixed income. The dashed line is total monthly income. Future months appear as gray estimates.",
    ...
    "Resource or lever": "Resource or lever",
    "Resource or lever...": "Resource or lever...",
    "Next in Time": "Next in Time",
    Upcoming: "Upcoming",
    "No upcoming items": "No upcoming items",
    "Time shows when life takes space; Resources explains the money.": "Time shows when life takes space; Resources explains the money.",
    "Events, trips and availability. Money details live in Resources.": "Events, trips and availability. Money details live in Resources.",
    Birthday: "Birthday",
    Event: "Event",
    Occupied: "Occupied",
    From: "From",
    ...
    Timeline: "Timeline",
    Project: "Project",
    "No projects yet. Create the first one.": "No projects yet. Create the first one.",
    "Edit project": "Edit project",
    "New project": "New project",
    "Project type": "Project type",
    "Example project": "E.g. Buy parking",
    "Planning questions": "Planning questions",
    "What outcome should this project create?": "What outcome should this project create?",
    "Desired outcome...": "Desired outcome...",
    "What is the next concrete step?": "What is the next concrete step?",
    "Next concrete step...": "Next concrete step...",
    "What decision or risk needs attention?": "What decision or risk needs attention?",
    "Decision, risk, limit...": "Decision, risk, limit...",
  ...
  es: {
    ...
    "Iter pillar projects": "Proyectos",
    "Iter pillar projects copy": "Convierte grandes intenciones en caminos concretos.",
    "Iter pillar time": "Tiempo",
    "Iter pillar time copy": "Entiende la capacidad real de tu hogar y familia.",
    "Iter pillar resources": "Recursos",
    "Iter pillar resources copy": "Comprende dinero, margen y viabilidad de tus planes.",
    "Access your Iter space": "Accede a tu espacio Iter",
    "Start a shared space": "Crea un espacio compartido",
    "Iter auth note": "Tus planes quedan conectados: lo que importa, cuándo puede pasar y qué recursos lo hacen posible.",
    "Variable expenses": "Gastos variables",
    Edit: "Editar",
    Structure: "Estructura",
    "Edit structure": "Editar estructura",
    Registered: "Registrado",
    "Went up {amount}": "Subió {amount}",
    "Went down {amount}": "Bajó {amount}",
    "Annual expense evolution": "Evolución del gasto anual",
    "Annual expense evolution help": "Las barras muestran los gastos del mes por capa. La línea continua es el ingreso fijo estable. La línea punteada es el ingreso total del mes. Los meses futuros aparecen como estimaciones en gris.",
    "Debt source": "Origen de deuda",
    "External debt": "Deuda externa",
    Language: "Idioma", Budget: "Presupuesto", Calendar: "Calendario", Home: "Casa", Today: "Hoy", "Add event": "+ Evento", "Add trip": "Viaje", Logout: "Salir", "Synced with API": "Sincronizado con API", "Local mode": "Modo local", Loading: "Cargando", Login: "Entrar", "Create account": "Crear cuenta", "Private access": "Acceso privado", "Application name": "Nombre de la aplicación", Username: "Usuario", Password: "Contraseña", "Logging in...": "Entrando...", "Creating...": "Creando...", "Could not create the account": "No se pudo crear la cuenta", "Could not log in": "No se pudo iniciar sesión",
    "Fixed income": "Ingresos fijos", "Previous card balance": "Saldo tarjeta mes anterior", "Variable income": "Ingresos variables", "Inactive potential": "Potencial sin activar", "Fixed expenses": "Gastos fijos", "Financial pressure": "Presión financiera", "Outstanding debt": "Deuda pendiente", "Monthly summary": "Resumen mensual", "Income · expenses · debt snapshot": "Ingresos · gastos · deuda", "Monthly adjustment": "Ajuste mensual", "guaranteed monthly": "mensual garantizado", "year to date": "acumulado", "monthly structure": "estructura mensual", "of committed income": "del ingreso comprometido", "Next payoff": "Próx. fin", "Income structure": "INGRESOS", "Guaranteed fixed · Recorded variable · Activatable potential": "Fijos garantizados · Variables registrados · Potencial activable", "Monthly total": "Total mensual", "This month total": "Total este mes", "Credit day": "Día de cobro", "Credit date": "Fecha de cobro", Credited: "Acredita", Day: "Día", Levers: "Palancas", New: "Nueva", "No levers yet": "Sin palancas aún", Active: "Activa", Activate: "Activar",
    ...
    "Block room": "Bloquear habitación", "Block car": "Bloquear coche", Availability: "Disponibilidad", "Availability / block": "Disponibilidad / bloqueo", "Resource or lever": "Recurso o palanca", "Resource or lever...": "Recurso o palanca...", "Next in Time": "Próximo en Tiempo", Upcoming: "Próximos", "No upcoming items": "Sin próximos ítems", "Time shows when life takes space; Resources explains the money.": "Tiempo muestra cuándo la vida ocupa espacio; Recursos explica el dinero.", "Events, trips and availability. Money details live in Resources.": "Eventos, viajes y disponibilidad. El detalle de dinero vive en Recursos.", Birthday: "Cumpleaños", Event: "Evento", Occupied: "Ocupada", From: "Desde", To: "Hasta", Note: "Nota", "Guests, reason...": "Huéspedes, motivo...", nights: "noches", night: "noche", "Save block": "Guardar bloqueo", "Start time": "Hora inicio", "End time": "Hora fin", "Monthly free balance": "saldo libre del mes", Extras: "Extras", Variable: "Variable", "By category": "Por categoría", "Expenses by category and funding": "Gasto por categoría y origen", record: "registro", records: "registros", Birthdays: "Cumpleaños", saved: "guardados", "No birthdays saved": "Sin cumpleaños guardados", days: "días", "Add birthday": "Agregar cumpleaños", "Supermarket purchases": "Compras del súper", Store: "Tienda", Product: "Producto", "Add product": "Agregar producto", "Save supermarket purchase": "Guardar compra del súper", "products tracked": "productos cargados", "Car ROI": "ROI Coche", of: "de",
    ...
    "Total projects": "Total proyectos", "Active projects": "Proyectos activos", Cards: "Tarjetas", Timeline: "Cronograma", Project: "Proyecto", "No projects yet. Create the first one.": "No hay proyectos todavía. Crea el primero.", "Edit project": "Editar proyecto", "New project": "Nuevo proyecto", "Project type": "Tipo de proyecto", "Example project": "Ej: Comprar parking", "Planning questions": "Preguntas guía", "What outcome should this project create?": "¿Qué resultado debería crear este proyecto?", "Desired outcome...": "Resultado deseado...", "What is the next concrete step?": "¿Cuál es el próximo paso concreto?", "Next concrete step...": "Próximo paso concreto...", "What decision or risk needs attention?": "¿Qué decisión o riesgo necesita atención?", "Decision, risk, limit...": "Decisión, riesgo, límite...", "Create project": "Crear proyecto", "Delete this project?": "¿Eliminar este proyecto?", Goal: "Objetivo", "Next step": "Próximo paso", Watch: "Atención", General: "General", "Major purchase": "Compra importante", Procedure: "Trámite", Finance: "Finanzas", Learning: "Aprendizaje", Work: "Trabajo",
  ...
  ca: {
    ...
    "Iter pillar projects": "Projectes",
    "Iter pillar projects copy": "Converteix grans intencions en camins concrets.",
    "Iter pillar time": "Temps",
    "Iter pillar time copy": "Entén la capacitat real de casa teva i la família.",
    "Iter pillar resources": "Recursos",
    "Iter pillar resources copy": "Comprèn diners, marge i viabilitat dels teus plans.",
    "Access your Iter space": "Accedeix al teu espai Iter",
    "Start a shared space": "Crea un espai compartit",
    "Iter auth note": "Els teus plans queden connectats: el que importa, quan pot passar i quins recursos ho fan possible.",
    "Variable expenses": "Despeses variables",
    Edit: "Editar",
    Structure: "Estructura",
    "Edit structure": "Editar estructura",
    Registered: "Registrat",
    "Went up {amount}": "Ha pujat {amount}",
    "Went down {amount}": "Ha baixat {amount}",
    "Annual expense evolution": "Evolució de la despesa anual",
    "Annual expense evolution help": "Les barres mostren les despeses del mes per capa. La línia contínua és l'ingrés fix estable. La línia puntejada és l'ingrés total del mes. Els mesos futurs apareixen com a estimacions en gris.",
    "Debt source": "Origen del deute",
    "External debt": "Deute extern",
    Language: "Idioma", Budget: "Pressupost", Calendar: "Calendari", Home: "Casa", Today: "Avui", "Add event": "+ Esdeveniment", "Add trip": "Viatge", Logout: "Sortir", "Synced with API": "Sincronitzat amb l'API", "Local mode": "Mode local", Loading: "Carregant", Login: "Entrar", "Create account": "Crear compte", "Private access": "Accés privat", "Application name": "Nom de l'aplicació", Username: "Usuari", Password: "Contrasenya", "Logging in...": "Entrant...", "Creating...": "Creant...", "Could not create the account": "No s'ha pogut crear el compte", "Could not log in": "No s'ha pogut iniciar sessió",
    "Fixed income": "Ingressos fixos", "Previous card balance": "Saldo targeta mes anterior", "Variable income": "Ingressos variables", "Inactive potential": "Potencial sense activar", "Fixed expenses": "Despeses fixes", "Financial pressure": "Pressió financera", "Outstanding debt": "Deute pendent", "Monthly summary": "Resum mensual", "Income · expenses · debt snapshot": "Ingressos · despeses · deute", "Monthly adjustment": "Ajust mensual", "guaranteed monthly": "mensual garantit", "year to date": "acumulat", "monthly structure": "estructura mensual", "of committed income": "de l'ingrés compromès", "Next payoff": "Proper final", "Income structure": "INGRESSOS", "Guaranteed fixed · Recorded variable · Activatable potential": "Fixos garantits · Variables registrats · Potencial activable", "Monthly total": "Total mensual", "This month total": "Total aquest mes", "Credit day": "Dia de cobrament", "Credit date": "Data de cobrament", Credited: "Acredita", Day: "Dia", Levers: "Palanques", New: "Nova", "No levers yet": "Encara no hi ha palanques", Active: "Activa", Activate: "Activar",
    ...
    "Total projects": "Total projectes", "Active projects": "Projectes actius", Cards: "Targetes", Timeline: "Cronograma", Project: "Projecte", "No projects yet. Create the first one.": "Encara no hi ha projectes. Crea el primer.", "Edit project": "Editar projecte", "New project": "Nou projecte", "Project type": "Tipus de projecte", "Example project": "Ex: Comprar pàrquing", "Planning questions": "Preguntes guia", "What outcome should this project create?": "Quin resultat hauria de crear aquest projecte?", "Desired outcome...": "Resultat desitjat...", "What is the next concrete step?": "Quin és el proper pas concret?", "Next concrete step...": "Proper pas concret...", "What decision or risk needs attention?": "Quina decisió o risc necessita atenció?", "Decision, risk, limit...": "Decisió, risc, límit...", "Create project": "Crear projecte", "Delete this project?": "Eliminar aquest projecte?", Goal: "Objectiu", "Next step": "Proper pas", Watch: "Atenció", General: "General", "Major purchase": "Compra important", Procedure: "Tràmit", Finance: "Finances", Learning: "Aprenentatge", Work: "Feina",
