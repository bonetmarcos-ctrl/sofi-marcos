...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "same month without debt payments": "same month without debt payments",
    "Monthly improvement": "Monthly improvement",
    "debt payments removed": "debt payments removed",
    "Debt-free month": "Debt-free month",
    "based on current installments": "based on current installments",
    "With debt": "With debt",
  ...
  ca: {
    "Variable expenses": "Despeses variables",
    ...
    "Edit event": "Editar esdeveniment", "New event": "Nou esdeveniment", Type: "Tipus", "Who is it for?": "De qui és?", "Booking details": "Dades de la reserva", Guests: "Hostes", "Example guests": "Ex: Marc & Sofia", Nights: "Nits", "per night": "€/nit", single: "individual", couple: "parella", "family/free": "família/gratis", Total: "Total", "Car rental": "Lloguer de cotxe", Days: "Dies", Net: "Net", Description: "Descripció", "What is it?": "Què és?", Date: "Data", Time: "Hora", "Amount (€)": "Import (€)", "Funding source": "Origen dels fons", "Payment method": "Forma de pagament", Cash: "Efectiu", "This month": "Aquest mes", Card: "Targeta", "Card name": "Nom de targeta", "Card closing day": "Dia de tancament", "Invoice date": "Data factura", "Due date": "Venciment", "Money available date": "Diners disponibles", "Money needed": "Necessari", "Real pressure": "Pressió real", "Purchase month": "Mes de compra", "Monthly income": "Ingressos del mes", "Credit card next month": "Targeta mes següent", "Credit card installments": "Targeta en quotes", "Debit month": "Mes de dèbit", "First debit month": "Primer mes de dèbit", Installments: "Quotes", Notes: "Notes", "Details...": "Detalls...", "Extra income": "Ingrés extra", "Variable expense": "Despesa variable", "Edit expense": "Editar despesa", "Save expense": "Guardar despesa", "Save changes": "Guardar canvis", "Save event": "Guardar esdeveniment", Delete: "Eliminar", "Delete this event?": "Eliminar aquest esdeveniment?", "Want to add a trip? Use the Add trip button in the main menu.": "Vols afegir un viatge? Usa el botó Viatge del menú principal.",
