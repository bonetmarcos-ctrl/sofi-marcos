...
describe("income timeline", () => {
  ...
  it("edits only the selected month while preserving later monthly totals", () => {
    const base = {
      ingresos_fijos:1000,
      detalle_ingresos:[{ id:"salary", nombre:"Salary", importe:1000, recurrente:true, fechaAcreditacion:"2026-06-28" }],
      monthlyOverrides:{
        "2026-06": { fixedIncome:1000 },
        "2026-07": { fixedIncome:1000 },
        "2026-08": { fixedIncome:1100 },
    ...
    const detalleIngresos = editarLineaIngresoEnMes(base.detalle_ingresos, 0, "2026-07", { importe:1200, fechaAcreditacion:"2026-06-26" }, { current:"salary-2026-07", future:"salary-2026-08" });
    const result = actualizarIngresosFijosDesdeMes(base, "2026-07", detalleIngresos);
  ...
  it("calculates the real credit date for the month", () => {
    expect(fechaAcreditacionIngresoEnMes({ fechaAcreditacion:"2026-06-26", desde:"2026-07", hasta:"2026-07" }, "2026-07")).toBe("2026-06-26");
    expect(fechaAcreditacionIngresoEnMes({ fechaAcreditacion:"2026-06-26" }, "2026-08")).toBe("2026-08-26");
